...
public class AiDeepSeekConfig implements CommandLineRunner{
    ...
    public static final String DS_OPENAI_API_CHAT_MODEL = "DS_OPENAI_API_CHAT_MODEL";
    
    @Primary
    @Bean(name = DS_OPENAI_API)
    public OpenAiApi chatCompletionApi() {
        return OpenAiApi.builder().baseUrl(baseUrl).apiKey(apiKey).build();
    }

    @Primary
    @Bean(name = DS_OPENAI_API_SEC)
    public OpenAiChatModel openAiClient(@Qualifier(DS_OPENAI_API) OpenAiApi openAiApi) {
    ...
    @Bean(name = DS_OPENAI_API_CHAT_MODEL)
