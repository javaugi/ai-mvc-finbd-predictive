...
public class UserInfoClient {
    ...
    static final List<UserInfo> USERS = List.of(
            UserInfo.builder().username("javaugi_g")
                    ...
                    .registrationId(AuthProvider.google.name())
                    .provider(AuthProvider.google).providerId(AuthProvider.google.name())
            ...
            UserInfo.builder().username("javaugi")
                    ...
                    .password("$2a$10$otFk6PYeXqFIPHp9rrN9gOvelESYT.a9dUa.evkcnbVEnhu3zeyry").name("D Lee").firstName("David")
                    .lastName("Lee").middleInitial("Z")
                    .registrationId(AuthProvider.github.name())
                    .provider(AuthProvider.github).providerId(AuthProvider.github.name())
                    .createdDate(OffsetDateTime.now()).updatedDate(OffsetDateTime.now()).build(),
            UserInfo.builder().username("javaugi_fhir")
                    .email("david.zt.lee@gmail.com")
                    .password("$2a$10$otFk6PYeXqFIPHp9rrN9gOvelESYT.a9dUa.evkcnbVEnhu3zeyry").name("D Lee").firstName("David")
                    .lastName("Lee").middleInitial("Z")
                    .registrationId(AuthProvider.epicfhir.name())
                    .provider(AuthProvider.epicfhir).providerId(AuthProvider.epicfhir.name())
                    .createdDate(OffsetDateTime.now()).updatedDate(OffsetDateTime.now()).build(),
            UserInfo.builder().username("javaugi.loc")
                    .email("dlee9591@gmail.com")
                    .password("$2a$10$otFk6PYeXqFIPHp9rrN9gOvelESYT.a9dUa.evkcnbVEnhu3zeyry").name("D Lee").firstName("David")
                    .lastName("Lee").middleInitial("Z")
                    .registrationId(AuthProvider.local.name())
                    .provider(AuthProvider.local).providerId(AuthProvider.local.name())
                    .createdDate(OffsetDateTime.now()).updatedDate(OffsetDateTime.now()).build()
    );
}
